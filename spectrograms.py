        ...
        if self.ttype == "ecg" or self.ttype == "ecg_log":
            ...
            if save:
                if self.savename is not None:#, bbox_inches='tight', pad_inches=0
                    if just_image:
                        plt.axis('off')
                        plt.savefig(self.outpath_png+self.savename+f'_{self.ttype}.png', interpolation="none", format="png", bbox_inches='tight', pad_inches=0)
                    else:
                        plt.savefig(self.outpath_png+self.savename+f'_{self.ttype}.png', interpolation="none", format="png")
                else:
                    if just_image:
                        plt.axis('off')
                        plt.savefig(self.outpath_png+self.filename+f'_{self.ttype}.png', interpolation="none", format="png", bbox_inches='tight', pad_inches=0)
                    else:
                        plt.savefig(self.outpath_png+self.filename+f'_{self.ttype}.png', interpolation="none", format="png")
            ...
            if save:
                if self.savename is not None:
                    if just_image:
                        plt.axis('off')
                        plt.savefig(self.outpath_png+self.savename+f'_{self.ttype}.png', format="png", interpolation="none", bbox_inches='tight', pad_inches=0)
                    else:
